...
#define CONF_SERCOM_1_I2CM_BAUD 1000000
#endif
...
#define CONF_SERCOM_1_I2CM_TRISE 20
#endif
...
#define CONF_SERCOM_1_I2CM_SPEED 0x02 // Speed: High speed mode
#endif
#if CONF_SERCOM_1_I2CM_TRISE < 20 || CONF_SERCOM_1_I2CM_TRISE > 40
#warning Bad I2C Rise time for High speed mode, reset to 20ns
...
#define CONF_SERCOM_1_I2CM_BAUD_BAUDLOW                                                                                \
	(((CONF_GCLK_SERCOM1_CORE_FREQUENCY - (CONF_SERCOM_1_I2CM_BAUD * 2) + (CONF_SERCOM_1_I2CM_BAUD / 2))               \
	  / CONF_SERCOM_1_I2CM_BAUD))
...
#define CONF_SERCOM_2_I2CM_BAUD 1000000
#endif
...
#define CONF_SERCOM_2_I2CM_TRISE 20
#endif
...
#define CONF_SERCOM_2_I2CM_SPEED 0x02 // Speed: High speed mode
#endif
#if CONF_SERCOM_2_I2CM_TRISE < 20 || CONF_SERCOM_2_I2CM_TRISE > 40
#warning Bad I2C Rise time for High speed mode, reset to 20ns
...
#define CONF_SERCOM_2_I2CM_BAUD_BAUDLOW                                                                                \
	(((CONF_GCLK_SERCOM2_CORE_FREQUENCY - (CONF_SERCOM_2_I2CM_BAUD * 2) + (CONF_SERCOM_2_I2CM_BAUD / 2))               \
	  / CONF_SERCOM_2_I2CM_BAUD))
